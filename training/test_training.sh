...
./generateToys.py
./keras_gan.py --input-file input_toys.h5 --prefix gan --train --iterations 101 --lr 1e-4
./keras_gan.py --input-file input_toys.h5 --prefix ganna --no-adv --train --iterations 101 --lr 1e-4
